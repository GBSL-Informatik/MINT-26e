...
• Du kommst **immer zum Ausgang**, **wenn** das Labyrinth **keine “schwebenden” Wände** oder **Inseln** hat. Die&#x20;

Links- oder Rechtsstrategie funktioniert auch in Labyrinthen mit schwebenden Wänden so lange Start und Ziel im gleichen, zusammenhängenden Bereich liegen. Wichtig ist nur, dass man sich immer an einer Wand orientieren kann. Nur wenn Start oder Ziel auf einer **abgetrennten** „Insel“ liegen, funktioniert die Methode **nicht**. Zum Beispiel funktioniert das untenstehende Labyrinth, obschon es (rot markiert) schwebende Wände hat.
